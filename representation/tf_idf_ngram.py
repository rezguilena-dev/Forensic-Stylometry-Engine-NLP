...
def generate_tfidf_ngrams():
    ...
    # Skip documents whose Category is 'orig'
    before = len(df_info)
    ...
    print("Génération de la matrice TF-IDF + N-grammes (1 à 3)...")
    ...
    print(f"\nSuccès !")
    print(f"Fichier créé : data/tfidf_ngrams.csv")
    print(f"Stats : {final_df.shape[0]} documents | {tfidf_df.shape[1]} caractéristiques (mots + suites).")


if __name__ == "__main__":
    generate_tfidf_ngrams()